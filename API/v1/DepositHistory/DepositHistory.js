...
module.exports = function (app) {
  //approved deposit
  app.get('/Api/v1/DepositHistory/Approved/UserTransactionID/:UserTransactionID/UserAccountID/:UserAccountID/', Security.rateLimiterMiddleware, function (req, res) {
  ...
  //archived deposit
  app.get('/Api/v1/DepositHistory/Archived/UserTransactionID/:UserTransactionID', Security.rateLimiterMiddleware, function (req, res) {
    let UserTransactionID = req.params.UserTransactionID;
    if (!isNullOrEmpty(UserTransactionID)) {
  ...
  app.get('/Api/v1/DepositHistory/Update/DepositHistoryID/:DepositHistoryID/UserAccountID/:UserAccountID/Status/Processing/ProcessingDATE/:ProcessingDATE/ProcessingTIME/:ProcessingTIME/', Security.rateLimiterMiddleware, function (req, res) {
  ...
  app.get('/Api/v1/DepositHistory/Update/DepositHistoryID/:DepositHistoryID/UserAccountID/:UserAccountID/Status/Rejected/RejectedDATE/:RejectedDATE/RejectedTIME/:RejectedTIME/', Security.rateLimiterMiddleware, function (req, res) {
    let DepositHistoryID = req.params.DepositHistoryID;
    let UserAccountID = req.params.UserAccountID;
  ...
  app.get('/Api/v1/DepositHistory/UserAccount/UserAccountID/:UserAccountID/Status/:Status/', Security.rateLimiterMiddleware, function (req, res) {
  ...
  app.get('/Api/v1/DepositHistory/Add/UserAccountID/:UserAccountID/Amount/:Amount/AccountHolder/:AccountHolder', Security.rateLimiterMiddleware, function (req, res) {
  ...
  app.get('/Api/v1/DepositHistory/Add/UserAccountID/:UserAccountID/Amount/:Amount/BankNameUsed/:BankNameUsed/SecurityCodeUsed/:SecurityCodeUsed/', Security.rateLimiterMiddleware, function (req, res) {
