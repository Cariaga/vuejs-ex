...
module.exports = function (app) { //MODIFY
  ...
  //SELECTION
  app.get('/Api/v1/GameHistory', Security.rateLimiterMiddleware,Security.cache.route({ expire: 5  }), function (req, res) {
