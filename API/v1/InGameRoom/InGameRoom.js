...
module.exports = function (app) {
    app.get('/Api/v1/InGameRoom/Update/UserAccountID/:UserAccountID/CurrentRoomName/:CurrentRoomName/', Security.globalBruteforce.prevent,Security.verifyToken, function (req, res) {
