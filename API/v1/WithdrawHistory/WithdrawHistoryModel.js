...
module.exports.RequestWithdraw = function RequestWithdraw(UserTransactionID, UserName, ContactNumber, BankName, AccountNumber, ApplicationAmount, ExistingAmount, RemainingAmount, callback) {
  let _UserTransactionID = UserTransactionID;
  let _UserName = UserName;
  let _ContactNumber = ContactNumber;
  let _BankName = BankName;
