...
module.exports = function (app) { //MODIFY
  app.get('/Api/v1/WithdrawHistory/Update/WithdrawHistoryID/:WithdrawHistoryID/UserAccountID/:UserAccountID/Status/', Security.globalBruteforce.prevent, function (req, res) {
  ...
  app.get('/Api/v1/WithdrawHistory/Add/UserAccountID/:UserAccountID/UserName/:UserName/ContactNo/:ContactNo/BankName/:BankName/AccountNumber/:AccountNumber/ApplicationAmount/:ApplicationAmount/', Security.globalBruteforce.prevent, function (req, res) {
    let UserAccountID = req.params.UserAccountID;
