...
module.exports = function (app) { //selection
    app.get('/Api/v1/InGameSeason/Request/UserAccountID/:UserAccountID/RoomID/:RoomID/', Security.rateLimiterMiddleware,Security.verifyToken, function (req, res) {
    ...
    app.post('/Api/v1/InGameSeason/SeasonEnd/SeasonID/:SeasonID/', Security.rateLimiterMiddleware, Security.verifyToken, function (req, res) {
