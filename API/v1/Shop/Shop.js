...
module.exports = function (app) { //MODIFY
  app.get('/Api/v1/Shop/Update/:ShopID/:UserAccountID/:DistributorID/:Description/', Security.rateLimiterMiddleware, function (req, res) {
  ...
  app.get('/Api/v1/Shop/Validate/:UserAccountID/', Security.rateLimiterMiddleware, function (req, res) { //check for validation only
  ...
  //INSERT
  app.get('/Api/v1/Shop/Add/UserAccountID/:UserAccountID/Name/:Name/PhoneNumber/:PhoneNumber/UserName/:UserName/Password/:Password/Commission/:Commission/DistributorID/:DistributorID/', Security.rateLimiterMiddleware, function (req, res) {
    let UserAccountID = req.params.UserAccountID;
  ...
  app.get('/Api/v1/Shop/Add/:UserAccountID/:DistributorID/:Description/', Security.rateLimiterMiddleware, function (req, res) {
    //Api/v1/Shop/Add/528861d4-3e49-4223-9b1a-913d72112112/1/Description/
    let UserAccountID = req.params.UserAccountID;
    let DistributorID = req.params.DistributorID;
    let Description = req.params.Description;
