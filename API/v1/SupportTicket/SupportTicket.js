...
module.exports = function (app) { //INSERT
  app.get('/Api/v1/SupportTicket/Add/UserAccountID/:UserAccountID/Title/:Title/Description/:Description/Reason/:Reason/Answer/:Answer/Status/:Status', Security.globalBruteforce.prevent, function (req, res) {
  ...
  app.get('/Api/v1/SupportTicket/Request/UserAccountID/:UserAccountID/Title/:Title/Reason/:Reason/', Security.globalBruteforce.prevent, Security.verifyToken, function (req, res) {
    let UserAccountID = req.params.UserAccountID;
    let Title = req.params.Title;
    let Description = req.params.Description;
    let Reason = req.params.Reason;
  ...
  app.get('/Api/v1/SupportTicket/Request/UserAccountID/:UserAccountID/Title/:Title/Reason/:Reason/', Security.globalBruteforce.prevent, function (req, res) {
    let UserAccountID = req.params.UserAccountID;
    let Title = req.params.Title;
    let Description = req.params.Description;
    let Reason = req.params.Reason;
  ...
  //MODIFY
  app.get('/Api/v1/SupportTicket/Update/SupportTicketID/:SupportTicketID/Answer/:Answer/Status/:Status', Security.globalBruteforce.prevent, function (req, res) {
  ...
  app.get('/Api/v1/SupportTicket/UserAccountID/:UserAccountID/Status/:Status', Security.globalBruteforce.prevent, function (req, res) {
