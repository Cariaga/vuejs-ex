...
module.exports = function (app) { //MODIFY
  app.get('/Api/v1/TransferHistory/Update/TransferHistoryUUID/:TransferHistoryUUID/Status/:Status/', Security.rateLimiterMiddleware, function (req, res) {
  ...
  //INSERT
  app.get('/Api/v1/TransferHistory/Add/UserAccountIDReceiver/:UserAccountIDReceiver/UserAccountIDSender/:UserAccountIDSender/Amount/:Amount/Reason/:Reason/', Security.rateLimiterMiddleware, function (req, res) {
  ...
  //SELECTION
  app.get('/Api/v1/TransferHistory/Search/Column/:Column/Value/:Value/StartDate/:StartDate/EndDate/:EndDate', Security.rateLimiterMiddleware,Security.verifyToken, function (req, res) {
