...
module.exports = function (app) { //MODIFY
  app.get('/Api/v1/RoomConfiguration/Update/RoomID/:RoomID/RoomNotice/:RoomNotice/', Security.globalBruteforce.prevent, function (req, res) {
  ...
  app.get('/Api/v1/RoomConfiguration/Update/RoomID/:RoomID/SmallBlind/:SmallBlind/BigBlind/:BigBlind/Speed/:Speed/GameType/:GameType', Security.globalBruteforce.prevent, function (req, res) {
    let RoomID = req.params.RoomID;
  ...
  //INSERT
  app.get('/Api/v1/RoomConfiguration/Add/RoomID/:RoomID/GameType/:GameType/SmallBlind/:SmallBlind/BuyIn/:BuyIn/Speed/:Speed/', Security.globalBruteforce.prevent, Security.verifyToken,function (req, res) {
  ...
  //SELECTION
  app.get('/Api/v1/RoomConfiguration/', Security.globalBruteforce.prevent, function (req, res) {
