...
module.exports = function (app) {
    ...
    app.post('/Api/v1/InGameTransferRequest/', Security.rateLimiterMiddleware, Security.verifyToken, function (req, res) {
    ...
    app.get('/Api/v1/InGameTransferRequest/UserAccountIDSender/:UserAccountIDSender/UserName/:UserName/Amount/:Amount/Password/:Password', Security.rateLimiterMiddleware, Security.verifyToken, function (req, res) {
