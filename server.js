...
//===========API===========
require('../vuejs-ex/API/v1/AccessControl/AccessControl')(app);
require('../vuejs-ex/API/v1/BankInformation/BankInformation')(app);
require('../vuejs-ex/API/v1/BlackList/BlackList')(app);
require('../vuejs-ex/API/v1/ConnectingUsers/ConnectingUsers')(app);
require('../vuejs-ex/API/v1/DashBoard/DashBoard')(app);
require('../vuejs-ex/API/v1/DepositHistory/DepositHistory')(app);
require('../vuejs-ex/API/v1/DepositList/DepositList')(app);
require('../vuejs-ex/API/v1/Distributor/Distributor')(app);
require('../vuejs-ex/API/v1/GameHistory/GameHistory')(app);
require('../vuejs-ex/API/v1/GameLogList/GameLogList')(app);
require('../vuejs-ex/API/v1/HandHistory/HandHistory')(app);
require('../vuejs-ex/API/v1/HandHistoryList/HandHistoryList')(app);
require('../vuejs-ex/API/v1/InGameMoney/InGameMoney')(app);
require('../vuejs-ex/API/v1/HeadOffice/HeadOffice')(app);
require('../vuejs-ex/API/v1/HeadOfficeList/HeadOfficeList')(app);
require('../vuejs-ex/API/v1/InGameAdminSupport/InGameAdminSupport')(app);
require('../vuejs-ex/API/v1/InGameAdminAnswer/InGameAdminAnswer')(app);
require('../vuejs-ex/API/v1/InGameDeposit/InGameDeposit')(app);
require('../vuejs-ex/API/v1/InGameFinalCard/InGameFinalCard')(app);
require('../vuejs-ex/API/v1/InGameNotice/InGameNotice')(app);
require('../vuejs-ex/API/v1/InGamePlayChips/InGamePlayChips')(app);
require('../vuejs-ex/API/v1/InGamePlayProfile/InGamePlayProfile')(app);
require('../vuejs-ex/API/v1/InGamePlayRoomNotice/InGamePlayRoomNotice')(app);
require('../vuejs-ex/API/v1/InGameRoom/InGameRoom')(app);
require('../vuejs-ex/API/v1/InGameScreenName/InGameScreenName')(app);
require('../vuejs-ex/API/v1/InGameSeasonPoints/InGameSeasonPoints')(app);
require('../vuejs-ex/API/v1/InGameTransferHistory/InGameTransferHistory')(app);
require('../vuejs-ex/API/v1/InGameTransferRequest/InGameTransferRequest')(app);
require('../vuejs-ex/API/v1/InGameNotice/InGameNotice')(app);
require('../vuejs-ex/API/v1/InGameWithdraw/InGameWithdraw')(app);
require('../vuejs-ex/API/v1/IPList/IPList')(app);
require('../vuejs-ex/API/v1/Login/Login')(app);
require('../vuejs-ex/API/v1/Login/LogOut')(app);
require('../vuejs-ex/API/v1/LoginHistory/LoginHistory')(app);
require('../vuejs-ex/API/v1/MemberBlackList/MemberBlackList')(app);
require('../vuejs-ex/API/v1/MemberList/MemberList')(app);
require('../vuejs-ex/API/v1/Notification/Notification')(app);
require('../vuejs-ex/API/v1/OneOnOne/OneOnOne')(app);
require('../vuejs-ex/API/v1/Pagination/Pagination')(app);
require('../vuejs-ex/API/v1/Player/Player')(app);
require('../vuejs-ex/API/v1/PlayerFinalCard/PlayerFinalCard')(app);
require('../vuejs-ex/API/v1/Poker/Poker')(app);
require('../vuejs-ex/API/v1/Profile/Profile')(app);
require('../vuejs-ex/API/v1/Register/Register')(app);
require('../vuejs-ex/API/v1/RoomConfiguration/RoomConfiguration')(app);
require('../vuejs-ex/API/v1/Shop/Shop')(app);
require('../vuejs-ex/API/v1/SupportTicket/SupportTicket')(app);
require('../vuejs-ex/API/v1/TransferHistory/TransferHistory')(app);
require('../vuejs-ex/API/v1/UserAccount/UserAccount')(app);
require('../vuejs-ex/API/v1/UserInfo/UserInfo')(app);
require('../vuejs-ex/API/v1/InGameUserSupportTicket/InGameUserSupportTicket')(app);
require('../vuejs-ex/API/v1/Verification/Verification')(app);
require('../vuejs-ex/API/v1/WithdrawHistory/WithdrawHistory')(app);
require('../vuejs-ex/API/v1/WithdrawHistoryList/WithdrawHistoryList')(app);
require('../vuejs-ex/API/v1/TransactionHistory/TransactionHistory')(app);
require('../vuejs-ex/API/v1/InGameScore/InGameScore')(app);
require('../vuejs-ex/API/v1/InGameSeason/InGameSeason')(app);
require('../vuejs-ex/API/v1/InGameRoomConfiguration/InGameRoomConfiguration')(app);
require('../vuejs-ex/API/v1/InGamePlayerWins/InGamePlayerWins')(app);
require('../vuejs-ex/API/v1/InGameBuyIn/InGameBuyIn')(app);
